...
Traditional Machine Learning Model is known to be trained on powerful GPU and gives out models ranging from to tens or hundred of Gigab
According to a recent report \cite{noauthor_microcontroller_nodate}, as of 2021, around 31 billion microcontroller (MCU) units were shipped worldwide annually. The MCU market size is projected to increase in the next years, as the market g. 
